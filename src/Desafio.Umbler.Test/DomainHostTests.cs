...
namespace Desafio.Umbler.Test
{
    ...
    public class DomainHostTests
    {
        ...
        public void NewDomainHost_ValidConstrutor_DomainHostValid()
        {
            ...
            // assert
            Assert.AreEqual(domainHost.Name, "teste.com.br");
            Assert.AreEqual(domainHost.Ip, "548.545.122.956");
            Assert.AreEqual(domainHost.WhoIs, "descrição whois");
            Assert.AreEqual(domainHost.HostedAt, "Teste LTDA");
            Assert.AreEqual(domainHost.Ttl, 50);
        }
        ...
        public void NewDomainHost_InvalidConstrutor_DomainHostInvalid()
        {
            ...
            Assert.AreEqual("Insira menos de 100 caracteres. (Parameter 'name')", ex2.Message);
            ...
            Assert.AreEqual("Insira menos de 15 caracteres. (Parameter 'ip')", ex4.Message);
            ...
            Assert.AreEqual("HostAt obrigatório! (Parameter 'hostedAt')", ex6.Message);
            ...
            Assert.AreEqual("Insira menos de 200 caracteres. (Parameter 'hostedAt')", ex7.Message);
        ...
        public void EditDomainHost_ValidEdit_ValidDomainHost()
        {
            ...
            // assert
            Assert.AreEqual(domainHost.Name, "terra.com.br");
            Assert.AreEqual(domainHost.Ip, "222.666.444.99");
            Assert.AreEqual(domainHost.WhoIs, "descrição whois alterada");
            Assert.AreEqual(domainHost.HostedAt, "Terra");
            Assert.AreEqual(domainHost.Ttl, 100);
        }
        ...
        public void EditDomainHost_InvalidEdit_InvalidDomainHost()
        {
            ...
            Assert.AreEqual("Insira menos de 15 caracteres. (Parameter 'ip')", ex2.Message);
